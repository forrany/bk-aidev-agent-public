...
def render_text_description(tools: list[BaseTool], use_func_sig: bool = False) -> str:
    """Render the tool name and description in plain text.

    Args:
        tools: The tools to render.
        use_func_sig: 启用是否使用func_sig的标识
    ...
    descriptions = []
    for tool in tools:
        if use_func_sig and hasattr(tool, "func") and tool.func:
...
def render_text_description_and_args(tools: list[BaseTool], use_func_sig: bool = False) -> str:
