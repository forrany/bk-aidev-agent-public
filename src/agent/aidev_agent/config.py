...
BKAI_AGENT_METRICS_EXPORT_INTERVAL_MILLIS = max(1000, env.int("BKAI_AGENT_METRICS_EXPORT_INTERVAL_MILLIS", 10_000))
BKAI_AGENT_METRICS_PUSH_MODE = env.str("BKAI_AGENT_METRICS_PUSH_MODE", "celery").strip().lower()
