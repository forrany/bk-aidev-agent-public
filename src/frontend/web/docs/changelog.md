...
- 更新 [提示词与资源](/guide/core-features/prompts)、[ChatBot API](/api/ai-blueking/chatbot)、[AIBlueking API](/api/ai-blueking/aiblueking)、[类型定义](/api/ai-blueking/types)、[chat-x 组件](/api/chat-x/components)
