  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'MentionText 标签文本', link: 'rendering/mention-text' },
        { text: 'MentionTag 资源标签', link: 'rendering/mention-tag' },
        { text: 'CollapsibleContent 折叠内容', link: 'rendering/collapsible-content' },
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'InputMenuPanel 输入框菜单', link: 'input/input-menu-panel' },
        { text: 'AddMenuBtn 添加菜单按钮', link: 'input/add-menu-btn' },
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'ResourceIcon 资源图标', link: 'helper/resource-icon' },
