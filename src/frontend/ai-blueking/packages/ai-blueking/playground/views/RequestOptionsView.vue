<template>
  <div class="request-options-view">
    <div class="view-header">
      ...
      <p class="view-desc">
        演示 <code>requestOptions</code> 的 headers / data 支持 ref、computed 与动态替换。
        GET 请求将 <code>data</code> 转为 query；POST 写入 body。
      </p>
    </div>
    ...
    <section class="demo-section">
      ...
      <p class="section-desc">便于在 Network 面板观察 GET query 与 POST body，切换上方按钮后刷新会话或发消息即可验证。</p>
...
// GET → ?app_id=... ；POST → body 合并 app_id
