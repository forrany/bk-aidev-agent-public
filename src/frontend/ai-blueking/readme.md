...
<p align="center">
  <a href="https://github.com/blueking/ai-blueking"><img src="https://img.shields.io/badge/版本-1.3.1-blue" alt="版本"></a>
...
<template>
  <div>
    <!-- 自定义触发按钮 -->
    <button class="my-ai-button" @click="openAI">
