    ...
    def extract(self, jsontext):
        ...
        try:
            if isinstance(jsontext, str):
                ...
                return ierror.WXBizMsgCrypt_OK, jsontext["encrypt"]
        except Exception as e:
            logger.info(e)
...
class Prpcrypt(object):
    ...
    def decrypt(self, text, receiveid):
        ...
        if from_receiveid != receiveid:
            logger.info("receiveid not match", receiveid, from_receiveid)
...
class WXBizJsonMsgCrypt(object):
    ...
    def EncryptMsg(self, sReplyMsg, sNonce, timestamp=None):
        ...
        if ret != 0:
            return ret, None
        jsonParse = JsonParse()
        return ret, jsonParse.generate(encrypt.decode("utf-8"), signature, timestamp, sNonce)
